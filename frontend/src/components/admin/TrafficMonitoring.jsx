...
export default function TrafficMonitoring() {
  ...
  const [alerts, setAlerts] = useState([
    { id: 1, type: 'violation', title: 'Violation: Illegal U-Turn detected', location: 'S.G. Highway - Thaltej, Ahmedabad', time: 'Just now', colorHex: '#EF4444', bgClass: 'bg-red-100', textClass: 'text-[#EF4444]' },
    { id: 2, type: 'warning', title: 'Congestion Warning: Heavy backlog building', location: 'Athwa Gate, Surat', time: '4 mins ago', colorHex: '#F59E0B', bgClass: 'bg-amber-100', textClass: 'text-[#F59E0B]' }
  ]);

  // States of each zone
  const [zones, setZones] = useState([
    { id: 1, name: 'S.G. Highway - Thaltej, Ahmedabad', latitude: 23.0507, longitude: 72.5110, vehicles: 942, congestion: 'HIGH', signal: 'Red', timer: 43, cam: 'CAM-GJ-001', videoUrl: '/videos/Hikvision_Traffic_Flow_Analysis_Camera_240P.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=S.G.+Highway+Thaltej+Ahmedabad+Gujarat' },
    { id: 2, name: 'Infocity Circle, Gandhinagar', latitude: 23.2156, longitude: 72.6369, vehicles: 726, congestion: 'MEDIUM', signal: 'Green', timer: 35, cam: 'CAM-GJ-006', videoUrl: '/videos/Vehicle Detection and Traffic Counting using AI..mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Infocity+Circle+Gandhinagar+Gujarat' },
    { id: 3, name: 'Alkapuri, Vadodara', latitude: 22.3100, longitude: 73.1700, vehicles: 864, congestion: 'MEDIUM', signal: 'Yellow', timer: 18, cam: 'CAM-GJ-009', videoUrl: '/videos/video_2.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Alkapuri+Vadodara+Gujarat' },
    { id: 4, name: 'Athwa Gate, Surat', latitude: 21.1858, longitude: 72.8095, vehicles: 1088, congestion: 'HIGH', signal: 'Red', timer: 52, cam: 'CAM-GJ-012', videoUrl: '/videos/video_3.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Athwa+Gate+Surat+Gujarat' },
    { id: 5, name: 'Varachha Road, Surat', latitude: 21.2134, longitude: 72.8755, vehicles: 618, congestion: 'MEDIUM', signal: 'Green', timer: 27, cam: 'CAM-GJ-014', videoUrl: '/videos/video_4.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Varachha+Road+Surat+Gujarat' },
    { id: 6, name: 'Kalawad Road, Rajkot', latitude: 22.3039, longitude: 70.8022, vehicles: 978, congestion: 'MEDIUM', signal: 'Yellow', timer: 12, cam: 'CAM-GJ-016', videoUrl: '/videos/video_3.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Kalawad+Road+Rajkot+Gujarat' },
    { id: 7, name: 'Ghogha Circle, Bhavnagar', latitude: 21.7645, longitude: 72.1519, vehicles: 544, congestion: 'LOW', signal: 'Green', timer: 46, cam: 'CAM-GJ-019', videoUrl: '/videos/video_2.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Ghogha+Circle+Bhavnagar+Gujarat' },
    { id: 8, name: 'Bedi Road, Jamnagar', latitude: 22.4707, longitude: 70.0577, vehicles: 1152, congestion: 'HIGH', signal: 'Red', timer: 58, cam: 'CAM-GJ-020', videoUrl: '/videos/video_4.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Bedi+Road+Jamnagar+Gujarat' },
    { id: 9, name: 'Majevadi Gate, Junagadh', latitude: 21.5222, longitude: 70.4579, vehicles: 438, congestion: 'LOW', signal: 'Green', timer: 31, cam: 'CAM-GJ-021', videoUrl: '/videos/video_2.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Majevadi+Gate+Junagadh+Gujarat' },
    { id: 10, name: 'Vallabh Vidyanagar Road, Anand', latitude: 22.5645, longitude: 72.9289, vehicles: 702, congestion: 'MEDIUM', signal: 'Yellow', timer: 22, cam: 'CAM-GJ-024', videoUrl: '/videos/video_3.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Vallabh+Vidyanagar+Road+Anand+Gujarat' },
    { id: 11, name: 'Zadeshwar Chowkdi, Bharuch', latitude: 21.7051, longitude: 72.9959, vehicles: 386, congestion: 'LOW', signal: 'Green', timer: 39, cam: 'CAM-GJ-028', videoUrl: '/videos/video_4.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Zadeshwar+Chowkdi+Bharuch+Gujarat' },
    { id: 12, name: 'GIDC Char Rasta, Vapi', latitude: 20.3718, longitude: 72.9146, vehicles: 1004, congestion: 'HIGH', signal: 'Red', timer: 16, cam: 'CAM-GJ-029', videoUrl: '/videos/Hikvision_Traffic_Flow_Analysis_Camera_240P.mp4', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=GIDC+Char+Rasta+Vapi+Gujarat' }
  ]);
  ...
  return (
    <div className="min-h-screen p-2 sm:p-4 lg:p-6 font-sans text-slate-900">
      ...
      <div className="mb-2 flex items-center justify-between">
        <h3 className="text-sm font-display font-bold text-slate-700 uppercase tracking-wider">Gujarat Grid Corridors ({zones.length})</h3>
