...
import { GUJARAT_ZONES, GUJARAT_CORRIDORS } from '../config/gujaratGeospatial.js';
...
let liveBangaloreZones = JSON.parse(JSON.stringify(GUJARAT_ZONES));
